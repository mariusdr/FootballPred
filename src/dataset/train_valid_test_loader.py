...
from dataset.dataset import SingleSeasonSingleLeague, SingleSeasonSingleLeagueTimeSlices
...
def make_dataset(sql_path,
    ...
    for league_tag, season_tag in season_list:
        if use_ts:
            d = SingleSeasonSingleLeagueTimeSlices(
                sql_path,
                league_tag,
                season_tag,
                slice_size=ts_size,
            ...
            d = SingleSeasonSingleLeague(
                ...
                league_tag,
                season_tag,
                undersample_probs=undersample_probs, load_odds=with_odds)
        datasets.append(d)
...
def make_small_test_set(sql_path,
    ...
    return make_dataset(
        ...
        undersample_probs=undersample_probs,
        use_ts=use_ts,
        ts_size=ts_size, with_odds=with_odds)
